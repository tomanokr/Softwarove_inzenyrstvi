...
\textbf{Softwarový proces} je množina činností, jejichž cílem je vývoj nebo modernizace software a jsou nutné k vytvoření softwarového produktu. Definuje \textbf{projekty}, které se vztahují k jednotlivým zakázkám. Každý projekt je tvořen \textbf{realizací} \textbf{(metodologií vývoje softwaru)}, která je vázána na vývoj produktu, a \textbf{řízením} \textbf{(metodologií řízení projektu), jehož úkolem je plánování projektu. 
